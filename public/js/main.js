...
var _Status = require('../components/Status.vue');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/var/www/html/slideweb/resources/assets/js/components/CheckBar.vue"
  if (!module.hot.data) {
...
},{"../components/Status.vue":29,"vue":27,"vue-hot-reload-api":2}],29:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<div class=\"col s12 offset-s0 m6 offset-m3 l6 offset-l3\">\n    <br>\n    <div class=\"card-panel\">\n        <div class=\"row center\">\n            <h4 class=\"light-blue-text light truncate\">{{ website.website.name }}</h4><br>\n            <div v-bind:class=\"{ 'online': website.online, 'offline': !website.online}\"></div>\n            <div class=\"grey-text lighten-1\">\n                <br>\n                <h5 class=\"green-text lighten-1 light\" v-show=\"website.online\">This website is online.</h5>\n                <h5 class=\"red-text lighten-1 light\" v-show=\"!website.online\">This website is offline.</h5>\n            </div>\n        </div>\n    </div>\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/var/www/html/slideweb/resources/assets/js/components/Status.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
exports.default = {
    ...
    methods: {
        getMostCheckedWebsites: function getMostCheckedWebsites() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/var/www/html/slideweb/resources/assets/js/components/WebsitesList.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
var _WebsitesList = require('./components/WebsitesList.vue');

var _WebsitesList2 = _interopRequireDefault(_WebsitesList);

var _CheckBar = require('./components/CheckBar.vue');

var _CheckBar2 = _interopRequireDefault(_CheckBar);
...
new Vue({
    ...
    components: { WebsitesList: _WebsitesList2.default, CheckBar: _CheckBar2.default },
...
},{"./components/CheckBar.vue":28,"./components/WebsitesList.vue":30,"vue":27,"vue-resource":16}]},{},[31]);
